...
class WikiSQLRetrieval(AbsTaskRetrieval):
    metadata = TaskMetadata(
        ...
        description="WikiSQL dataset comprising hand-annotated examples of natural language questions and corresponding SQL queries across tables from Wikipedia",
