...
class CUREv1EnRetrieval(AbsTaskRetrieval):
    metadata = TaskMetadata(
        ...
        description="CURE v1 English dataset for comprehensive retrieval evaluation across multiple domains and tasks",
        reference="https://huggingface.co/datasets/embedding-benchmark/CUREv1_en_mteb",
        dataset={
            "path": "embedding-benchmark/CUREv1_en_mteb",
            "revision": "main",
        },
        type="Retrieval",
        category="s2p",
